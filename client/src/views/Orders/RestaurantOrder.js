      ...
      <Table  aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">Select Robot</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
            ...
            >
              ...
              <Button onClick={handleClickOpen(row.OrderId)}>Edit Order</Button>
                            <Dialog disableEscapeKeyDown open={open} onClose={handleClose}>
                                ...
                                <DialogTitle>Select Robot</DialogTitle>
                                <DialogContent>
              ...
              <Button onClick={handleClickOpen(row.OrderId)}>Select Robot</Button>
              <Dialog disableEscapeKeyDown open={open} onClose={handleClose}>
                                {/* <DialogTitle>Update Order Status</DialogTitle> */}
                                <DialogTitle>Select Robot</DialogTitle>
                                <DialogContent>
